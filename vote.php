									...
									<div class="panel panel-primary">
										...
										<div class="panel-body">
											<div class="row">
												...
												$stmt->execute();
												$stmt->store_result();
												$stmt->bind_result($id, $fname, $lname, $gender, $level, $party, $img);
												...
												?>
													<div class="col-sm-6 col-md-4">
														<div class="candidate-card">
															<img src="admin/<?= htmlspecialchars($img) ?>" width="130" height="130" class="candidate-img img-thumbnail">
															<p><strong><?= htmlspecialchars($fname . " " . $lname) ?></strong></p>
															<p>Gender: <?= htmlspecialchars($gender) ?></p>
															<p>Level: <?= htmlspecialchars($level) ?></p>
															<p>Party: <?= htmlspecialchars($party) ?></p>
															<label>
																<input type="radio" name="<?= $input_name ?>" value="<?= $id ?>" required>
																Give Vote
															</label>
